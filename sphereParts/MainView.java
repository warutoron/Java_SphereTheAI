...
public class MainView extends JFrame {
	...
	// 状態変化用セットメソッド
	public void setInputMode(int newMode) {InputMode = newMode;}
	public void setRecordingMode(int newMode) {RecordingMode = newMode;}
	public void setRandomMode(int newMode) {RandomMode = newMode;}
	// ユーザ・スフィアのメッセージを一時保管
	public void setUserIdea(String message){this.userIdeas = message;}
	public void setSphereIdea(String message){this.sfiaIdeas = message;}
	// ユーザ・スフィアのメッセージを返す
	public String getUserIdea(){return this.userIdeas;}
	public String getSphereIdea(){return this.sfiaIdeas;}	
}
